...
namespace PGSauce.Core.FSM.Scripted.Example
{
    public class Player : MonoStateMachineScripted<Player>
    {
        ...
        private List<AnyTransitionBase<Player>> _any;
        ...
        protected override List<AnyTransitionBase<Player>> AnyTransitions => _any;
        ...
        protected override void InitializeStates()
        {
            ...
            _any = new List<AnyTransitionBase<Player>> {new AnyTransitionScripted<Player>(_dead, () => IsDead, false, new List<StateBase<Player>>() {_immortal})};
        }
