...
namespace PGSauce.UI
{
    ...
    {
        [SerializeField, FoldoutGroup("Audio")] private AudioObject showClip;
        [SerializeField, FoldoutGroup("Audio")] private AudioObject hideClip;
        ...
        public AudioObject HideClip => hideClip;

        public AudioObject ShowClip => showClip;
